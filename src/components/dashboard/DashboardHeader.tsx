    ...
    <header className="flex items-center justify-between px-5 py-3 border-b border-border bg-card/80 backdrop-blur-sm z-10">
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2.5">
          <span className="text-phantom-green font-mono text-xl font-bold tracking-tight glow-green-text select-none">
            ◉⟁⬡
          </span>
          <div>
            <h1 className="text-base font-semibold tracking-wide text-foreground leading-none">
              PHANTOM POE ENGINE
            </h1>
            <p className="text-sm font-mono text-muted-foreground tracking-widest mt-0.5">
      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded bg-secondary border border-border">
